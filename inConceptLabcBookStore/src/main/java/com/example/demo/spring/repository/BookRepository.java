...
/*
    ...
    @Query("select new com.example.demo.model.BookEntity(b.id, b.name, b.pageCount, b.isbn, b.genreEntity, b.authorEntity, b.publisherEntity, b.publishYear, b.image, b.descr, b.viewCount, b.totalRating, b.totalVoteCount, b.avgRating) from BookEntity b where b.genreEntity.id=:genreId")
